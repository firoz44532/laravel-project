...
echo "Carousel এর জন্য ১০টি ছবি ডাউনলোড করা হচ্ছে...\n";
echo "==========================================\n";

// ১০টি আকর্ষণীয় carousel ছবির URL
$carouselImages = [
    ...
    'banners/beauty-care.jpg' => 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600',
    'banners/groceries-sale.jpg' => 'https://images.pexels.com/photos/1109354/pexels-photo-1109354.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600',
    'banners/sports-fitness.jpg' => 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=1200&h=600&fit=crop&auto=format',
    'banners/toys-games.jpg' => 'https://images.pexels.com/photos/163352/pexels-photo-163352.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600',
    'banners/computer-deal.jpg' => 'https://images.unsplash.com/photo-1519389950471-1ba77f4a4d39?w=1200&h=600&fit=crop&auto=format',
    'banners/books-media.jpg' => 'https://images.pexels.com/photos/815557/pexels-photo-815557.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600',
    'banners/flash-sale.jpg' => 'https://images.unsplash.com/photo-1607082318824-0b96f6288b6b?w=1200&h=600&fit=crop&auto=format'
];

$downloadedCount = 0;
$failedCount = 0;

foreach ($carouselImages as $imagePath => $imageUrl) {
...
// এখন ১০টি banner তৈরি করুন
echo "\n১০টি Hot Selling Banner তৈরি করা হচ্ছে...\n";
...
$hotBanners = [
    ...
    [
        'title' => '📚 Books & Media',
        'description' => 'Knowledge & Entertainment - Great Collection!',
        'image' => 'banners/books-media.jpg',
