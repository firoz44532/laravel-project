...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Edit Shipping Zone</h1>
                <p class="text-gray-600 mt-2">Update shipping zone configuration and rates</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg">
        ...
        <form method="POST" action="{{ route('admin.shipping.zones.update', $zone) }}" class="p-6">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ $zone->description }}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea id="cities" 
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ $zone->cities ? (is_array($zone->cities) ? implode(', ', $zone->cities) : $zone->cities) : '' }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="areas" 
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ $zone->areas ? (is_array($zone->areas) ? implode(', ', $zone->areas) : $zone->areas) : '' }}</textarea>
                    ...
                    @foreach($availableMethods as $method)
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   {{ $zone->shippingMethods->contains($method->id) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                            ...
                            @php
                                ...
                                $currentCost = $zoneMethod ? $zoneMethod->pivot->cost : 0;
                            @endphp
                            <input type="number" 
