...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-2">Add a new delivery method to your shipping system</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white shadow rounded-lg">
        ...
        <form method="POST" action="{{ route('admin.shipping.methods.store') }}" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center">
                    ...
                    <p class="text-sm text-gray-500 ml-4">Customers can track shipments for this method</p>
                </div>
            </div>
            ...
            <div class="mt-8 flex justify-end space-x-4">
                ...
                <button type="submit" class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors font-medium">
                    <i class="fas fa-save mr-2"></i>Create Method
                </button>
            </div>
        </form>
    </div>
