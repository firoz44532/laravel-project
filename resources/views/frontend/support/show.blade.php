    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <a href="{{ route('support.index') }}" class="text-blue-600 hover:text-blue-800 font-medium mb-2 inline-block">
                ...
                @if($ticket->isOpen())
                    <form method="POST" action="{{ route('support.close', $ticket->id) }}" class="inline">
                        @csrf
                        <button type="submit" class="bg-gray-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-gray-700 transition duration-200">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex flex-wrap items-center gap-4 mb-4">
                ...
                @if($ticket->assignedTo)
                    <span class="text-sm text-gray-600">
                        <i class="fas fa-user mr-1"></i>Assigned to {{ $ticket->assignedTo->name }}
                    </span>
                @endif
            </div>
        ...
        @if($ticket->isOpen())
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <form method="POST" action="{{ route('support.reply', $ticket->id) }}" class="p-6">
                    @csrf
                    <div class="mb-4">
        ...
        @else
            <div class="bg-gray-100 rounded-lg p-6 text-center">
                ...
                <a href="{{ route('support.create') }}" class="text-blue-600 hover:text-blue-800 font-medium mt-3 inline-block">
                    Create a new ticket
                </a>
            </div>
        @endif
